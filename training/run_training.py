...
def main():
    ...
    parser.add_argument('--tag', default="{}".format(gen_random_str()), required=False,
                        help='Run identifier.')
    parser.add_argument('--patch_size', type=int, nargs='+', default=[256,256], required=False,
                        help='patch size.')
    ...
    elif model_name == "unet_fvfdsdg":
        from deeplearning.training.train_nets.train_unet_fvfdsdg import train
    else:
